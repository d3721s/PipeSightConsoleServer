...
export const imuLastRxAgeS = ref<number | null>(null)
...
export const imuSkippedBytes = ref<number | null>(null)
export const imuBufferedBytes = ref<number | null>(null)
export const imuLastRxHex = ref<string | null>(null)
export const imuLastFrameHex = ref<string | null>(null)
export const imuLastBadFrameHex = ref<string | null>(null)
  ...
  if (chassisTimer === null) {
    chassisTimer = window.setInterval(async () => {
      try {
        ...
        imuLastRxAgeS.value = t.imuLastRxAgeS ?? null
        imuRxBytes.value = t.imuRxBytes ?? null
        imuValidFrames.value = t.imuValidFrames ?? null
        imuBadFrames.value = t.imuBadFrames ?? null
        imuSkippedBytes.value = t.imuSkippedBytes ?? null
        imuBufferedBytes.value = t.imuBufferedBytes ?? null
        imuLastRxHex.value = t.imuLastRxHex ?? null
        imuLastFrameHex.value = t.imuLastFrameHex ?? null
        imuLastBadFrameHex.value = t.imuLastBadFrameHex ?? null
        ...
        imuLastRxAgeS.value = null
        imuRxBytes.value = null
        imuValidFrames.value = null
        imuBadFrames.value = null
        imuSkippedBytes.value = null
        imuBufferedBytes.value = null
        imuLastRxHex.value = null
        imuLastFrameHex.value = null
        imuLastBadFrameHex.value = null
